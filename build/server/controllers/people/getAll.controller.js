...
const getAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield people_1.peopleProvider.getAll(req.query.page || 1, req.query.limit || 7, req.query.filter || "");
    const count = yield people_1.peopleProvider.count(req.query.filter);
